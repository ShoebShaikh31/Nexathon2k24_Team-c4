            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-3 col-md-6">
                        ...
                        © C4 Construction 2024. All rights reserved. | Privacy Policy | Terms of Service | Contact Us
                        </span>
                    ...
                    <div className="col-lg-3 col-md-6">
                        ...
                        <ul className="footer-ul">
                            <li className="d-flex">
                                <div className="footer-info-item"><i className="fas fa-clock"></i></div> <span>09:00-05:00</span>
                            </li>
                            <li className="d-flex">
                                <div className="footer-info-item" ><i className="fas fa-envelope"></i></div> <span>c4construction@gmail.com</span>
                            </li>
                            <li className="d-flex">
                                <div className="footer-info-item"><i className="fas fa-map-marker-alt"></i></div> <span>Bandra West, Mumbai</span>
                            </li>
                            <li className="d-flex">
                                <div className="footer-info-item"><i className="fas fa-phone-alt"></i></div> <span>+91 98765 56789</span>
                            </li>
                        </ul>
                    </div>
                    {/*<div className="col-lg-3 col-md-6">
